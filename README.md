...
baseline, head is **0027**. `BANKASSIST_DATABASE_URL` is the single source of
...
olink-bank-assist/
  ...
  migrations/         Alembic environment + versions (0001 baseline .. 0027 head)
...
alone. **431 strings across three tables, no gaps:**
